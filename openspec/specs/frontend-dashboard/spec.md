...
The system SHALL provide a "View Script" button on each episode row that opens a wide shadcn Dialog (90vw, max 7xl) displaying the episode's `scriptText` in a chat-bubble style.
