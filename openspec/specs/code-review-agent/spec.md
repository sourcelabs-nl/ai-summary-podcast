# Capability: Code Review Agent

## Purpose

Automated code review agent for Claude Code that validates Kotlin code against architectural rules (controller hygiene, service layer, Spring Data JDBC, database consistency, testing, and Jackson 3.x).
