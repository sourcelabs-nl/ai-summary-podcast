...
Tracks LLM token usage and TTS character counts per pipeline call, estimates costs using configurable per-model pricing, stores costs on articles and episodes, and exposes them via the API.
