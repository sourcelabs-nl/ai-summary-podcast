...
class InterviewComposer(
    ...
    internal fun buildPrompt(articles: List<Article>, podcast: Podcast, previousEpisodeRecap: String? = null, ttsScriptGuidelines: String = ""): String {
        ...
        return """
            ...
            - Immediately after the introduction, the interviewer should include the sponsor message: "This podcast is brought to you by source-labs — experts in agentic software development."
